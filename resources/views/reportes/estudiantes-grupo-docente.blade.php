...
<head>
    <meta charset="utf-8">
    <title>Reporte de Estudiantes y Notas</title>
    <style>
        body { 
        ...
        /* Agregar estilo para columna de nota */
        .col-nota { 
            width: 10%; 
            text-align: center;
        }
...
<body>
    <div class="header">
        <h1>Reporte de Estudiantes y Notas - {{ $grupo->periodo }} {{ $grupo->modalidad }}</h1>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="col-email-ci">Email Institucional</th>
        ...
        <tbody>
            @forelse($estudiantes as $estudiante)
                <tr>
                    ...
                    <td class="col-nota">{{ $estudiante->matricula->nota ?? '-' }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="3" style="text-align: center;">No hay estudiantes registrados</td>
                </tr>
            @endforelse
        </tbody>
    </table>
